...
// call missing. `-k` left in #3095 for the same reason again: the keyword
// option is built, and `set -o keyword` grants it under its long name, so a
// letter listed here would refuse what the name gives.
//
