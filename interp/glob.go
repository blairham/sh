...
func (r *Runner) matchIn(dir, pattern string, o patternOpts, seeHidden bool) []string {
	...
	var out []string
	for _, name := range r.globListedNames(entries) {
...
// globListedNames is the names a component match may reach in one directory,
...
func (r *Runner) globListedNames(entries []os.DirEntry) []string {
