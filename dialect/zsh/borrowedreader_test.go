...
// line will not parse.
//
// The split that makes this two questions: a file is read a command at a time and `eval`'s text is read through first, so the file leaves its mark and `eval` leaves none.
//
...
// Measured against zsh 5.9.2, 2026-09-11.
