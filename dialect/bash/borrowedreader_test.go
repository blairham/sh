...
// line will not parse.
//
// Both read a command at a time, so the line before the one that will not parse has already run when the complaint is written.
//
...
// Measured against bash 5.3.15, 2026-09-11.
