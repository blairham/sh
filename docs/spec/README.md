...
## Layout
    ...
    ash.md            the fifth dialect, and the one no instrument grades
    ...
    prompt-theme.md   a prompt drawn from a configuration, in every dialect
    ...
    random.md         what a seed makes `$RANDOM` answer, per shell
