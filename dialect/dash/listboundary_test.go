...
// field of its own. This shell and BusyBox ash against bash, ksh93 and zsh; see
// Semantics.UnquotedListBoundaryIsIFSWhitespace for the whole grid and the
// readings it rules out.
//
// Measured against dash 0.5.12 on 2026-09-26. The field count is asserted beside the fields because the
